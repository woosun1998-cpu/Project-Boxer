/**
 * 구글 드라이브 이미지 — 파일 ID → lh3 임베드 URL (=w2000)
 * 무엇: 한곳에서 ID만 관리 / 왜: uc?export=view는 usercontent로 넘어가며 CORP 제한으로 로컬(5500)에서 img·CSS url()이 깨질 수 있음
 */
(function (global) {
  var U = "https://lh3.googleusercontent.com/d/";
  function uc(id) {
    return U + id + "=w2000";
  }
